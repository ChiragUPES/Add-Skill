...
function initAdmin() {
  ...
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/admin/orders', {
    ...
    orders = res.data; //console.log("Done");
...
var addTocart = document.querySelectorAll(".cartadd");
var cartcounter = document.querySelector('#cartCounter');

function updatecart(pizza) {
  // this will add the pizza into cart through ajax call
  // for ajax we can use fetch or use library axios
  // route, data which we want to send
...
addTocart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); // get pizza details
    //console.log(pizza);   // receive data into string so convert to object(JSON.parse).
...
__webpack_require__(/*! /root/Documents/AddSkill/Projects/Pizza-Order/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /root/Documents/AddSkill/Projects/Pizza-Order/resources/scss/app.scss */"./resources/scss/app.scss");
